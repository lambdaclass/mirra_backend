...
goog.exportSymbol('proto.Element', null, global);
...
proto.Polygon.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.Polygon.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 */
proto.Polygon.prototype.getVerticesList = function() {
 ...
 * @return {!proto.Polygon} returns this
*/
proto.Polygon.prototype.setVerticesList = function(value) {
 ...
 * @return {!proto.Position}
 */
proto.Polygon.prototype.addVertices = function(opt_value, opt_index) {
 ...
 * @return {!proto.Polygon} returns this
 */
proto.Polygon.prototype.clearVerticesList = function() {
...
proto.GameState.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    polygonsMap: (f = msg.getPolygonsMap()) ? f.toObject(includeInstance, proto.Polygon.toObject) : []
  };
...
proto.GameState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = msg.getPolygonsMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readUint64, jspb.BinaryReader.prototype.readMessage, proto.Polygon.deserializeBinaryFromReader, 0, new proto.Polygon());
         });
      break;
    default:
      reader.skipField();
...
proto.GameState.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getPolygonsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(2, writer, jspb.BinaryWriter.prototype.writeUint64, jspb.BinaryWriter.prototype.writeMessage, proto.Polygon.serializeBinaryToWriter);
  }
};
...
/**
 * map<uint64, Polygon> polygons = 2;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<number,!proto.Polygon>}
 */
proto.GameState.prototype.getPolygonsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<number,!proto.Polygon>} */ (
 ...
 * @return {!proto.GameState} returns this
 */
proto.GameState.prototype.clearPolygonsMap = function() {
  this.getPolygonsMap().clear();
  return this;
};
 ...
 * @const
 */
proto.Element.repeatedFields_ = [7];
 ...
 * @return {number}
 */
proto.Element.prototype.getId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.Element.prototype.setId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.Element.prototype.getShape = function() {
 ...
 * @return {!proto.Element} returns this
 */
proto.Element.prototype.setShape = function(value) {
 ...
 * @return {string}
 */
proto.Element.prototype.getName = function() {
 ...
 * @return {!proto.Element} returns this
 */
proto.Element.prototype.setName = function(value) {
 ...
 * @return {?proto.Position}
 */
proto.Element.prototype.getPosition = function() {
  return /** @type{?proto.Position} */ (
 ...
 * @return {!proto.Element} returns this
*/
proto.Element.prototype.setPosition = function(value) {
 ...
 * @return {!proto.Element} returns this
 */
proto.Element.prototype.clearPosition = function() {
  return this.setPosition(undefined);
};
 ...
 * @return {boolean}
 */
proto.Element.prototype.hasPosition = function() {
 ...
 * @return {number}
 */
proto.Element.prototype.getRadius = function() {
 ...
 * @return {!proto.Element} returns this
 */
proto.Element.prototype.setRadius = function(value) {
 ...
 * @return {!Array<!proto.Position>}
 */
proto.Element.prototype.getVerticesList = function() {
  return /** @type{!Array<!proto.Position>} */ (
 ...
 * @return {!proto.Element} returns this
*/
proto.Element.prototype.setVerticesList = function(value) {
 ...
 * @return {!proto.Position}
 */
proto.Element.prototype.addVertices = function(opt_value, opt_index) {
