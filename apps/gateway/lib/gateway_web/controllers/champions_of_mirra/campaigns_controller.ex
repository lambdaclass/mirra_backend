defmodule GatewayWeb.ChampionsOfMirra.CampaignsController do
  ...
  def get_campaigns(conn, _params) do
    ChampionsOfMirra.Campaigns.get_campaigns() |> GatewayWeb.Utils.format_response()
  end

  def get_campaign(conn, %{"campaign_number" => campaign_number}) do
    ChampionsOfMirra.Campaigns.get_campaign(campaign_number) |> GatewayWeb.Utils.format_response()
  end

  def get_level(conn, %{"level_id" => level_id}) do
    ChampionsOfMirra.Campaigns.get_level(level_id) |> GatewayWeb.Utils.format_response()
  end
