defmodule GatewayWeb.ChampionsOfMirra.ItemsController do
  ...
  def get_item(conn, %{"item_id" => item_id}) do
    ChampionsOfMirra.Items.get_item(item_id) |> GatewayWeb.Utils.format_response(conn)
  end

  def level_up(conn, %{"user_id" => user_id, "item_id" => item_id}) do
    ChampionsOfMirra.Items.level_up(user_id, item_id) |> GatewayWeb.Utils.format_response(conn)
  end
end
