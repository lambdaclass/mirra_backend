...
defmodule Gateway.Serialization.SkillAction do
  ...
  field(:skill_action_type, 4, type: :string, json_name: "skillActionType")
...
defmodule Gateway.Serialization.ModifierReceived do
  ...
  field(:stat_affected, 3, type: :string, json_name: "statAffected")
