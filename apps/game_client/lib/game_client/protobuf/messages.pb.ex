...
defmodule GameClient.Protobuf.Player do
  ...
  field(:natural_healing_interval, 8, type: :uint64, json_name: "naturalHealingInterval")
  field(:last_natural_healing_update, 9, type: :uint64, json_name: "lastNaturalHealingUpdate")
end
