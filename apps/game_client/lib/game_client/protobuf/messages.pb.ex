...
defmodule GameClient.Protobuf.ServerToggleBots do
  @moduledoc false
...
defmodule GameClient.Protobuf.GameEvent do
  ...
  field(:server_toggle_bots, 5,
    type: GameClient.Protobuf.ServerToggleBots,
...
defmodule GameClient.Protobuf.ClientToggleBots do
  @moduledoc false
...
defmodule GameClient.Protobuf.GameAction do
  ...
  field(:client_toggle_bots, 7,
    type: GameClient.Protobuf.ClientToggleBots,
