...
defmodule GameClient.Protobuf.GameState.PlayerMovementTimestampsEntry do
  @moduledoc false
...
defmodule GameClient.Protobuf.GameState.PlayerActionsTimestampsEntry do
  @moduledoc false
...
defmodule GameClient.Protobuf.GameState do
  ...
  field(:player_movement_timestamps, 4,
    repeated: true,
    type: GameClient.Protobuf.GameState.PlayerMovementTimestampsEntry,
    json_name: "playerMovementTimestamps",
    map: true
  )

  field(:player_actions_timestamps, 5,
    repeated: true,
    type: GameClient.Protobuf.GameState.PlayerActionsTimestampsEntry,
    json_name: "playerActionsTimestamps",
    map: true
  )

  field(:server_timestamp, 6, type: :int64, json_name: "serverTimestamp")
  field(:zone, 7, type: GameClient.Protobuf.Zone)
  field(:killfeed, 8, repeated: true, type: GameClient.Protobuf.KillEntry)

  field(:damage_taken, 9,
    repeated: true,
  ...
  field(:status, 12, type: GameClient.Protobuf.GameStatus, enum: true)
  field(:countdown, 13, type: :int64)
  field(:items, 14, repeated: true, type: GameClient.Protobuf.GameState.ItemsEntry, map: true)
end
