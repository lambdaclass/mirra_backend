...
goog.exportSymbol('proto.PickQuest', null, global);
 ...
 * @constructor
 */
proto.PickQuest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.PickQuest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.PickQuest.displayName = 'proto.PickQuest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.PickQuest.prototype.toObject = function(opt_includeInstance) {
  return proto.PickQuest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.PickQuest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PickQuest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.PickQuest}
 */
proto.PickQuest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.PickQuest;
  return proto.PickQuest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.PickQuest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.PickQuest}
 */
proto.PickQuest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.PickQuest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.PickQuest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.PickQuest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PickQuest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.PickQuest.prototype.getQuestId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.PickQuest} returns this
 */
proto.PickQuest.prototype.setQuestId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @const
 */
proto.GameAction.oneofGroups_ = [[1,2,4,5]];
...
proto.GameAction.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pickQuest: (f = msg.getPickQuest()) && proto.PickQuest.toObject(includeInstance, f),
...
proto.GameAction.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.PickQuest;
      reader.readMessage(value,proto.PickQuest.deserializeBinaryFromReader);
      msg.setPickQuest(value);
      break;
    case 3:
      var value = /** @type {number} */ (reader.readInt64());
...
proto.GameAction.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getPickQuest();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.PickQuest.serializeBinaryToWriter
    );
  }
...
/**
 * optional PickQuest pick_quest = 5;
 * @return {?proto.PickQuest}
 */
proto.GameAction.prototype.getPickQuest = function() {
  return /** @type{?proto.PickQuest} */ (
    jspb.Message.getWrapperField(this, proto.PickQuest, 5));
};


/**
 * @param {?proto.PickQuest|undefined} value
 * @return {!proto.GameAction} returns this
*/
proto.GameAction.prototype.setPickQuest = function(value) {
 ...
 * @return {!proto.GameAction} returns this
 */
proto.GameAction.prototype.clearPickQuest = function() {
  return this.setPickQuest(undefined);
};
 ...
 * @return {boolean}
 */
proto.GameAction.prototype.hasPickQuest = function() {
  return jspb.Message.getField(this, 5) != null;
};
