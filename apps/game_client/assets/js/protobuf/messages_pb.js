...
goog.exportSymbol('proto.GameEvent.EventTypeCase', null, global);
 ...
 * @return {number}
 */
proto.PlayerJoined.prototype.getPlayerId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.PlayerJoined.prototype.setPlayerId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
...
/**
 * @return {proto.GameEvent.EventTypeCase}
 */
proto.GameEvent.prototype.getEventTypeCase = function() {
  return /** @type {proto.GameEvent.EventTypeCase} */(jspb.Message.computeOneofCase(this, proto.GameEvent.oneofGroups_[0]));
};
...
proto.GameEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    playerId: (f = msg.getPlayerId()) && proto.PlayerJoined.toObject(includeInstance, f),
...
proto.GameEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.PlayerJoined;
      reader.readMessage(value,proto.PlayerJoined.deserializeBinaryFromReader);
      msg.setPlayerId(value);
      break;
    case 2:
...
proto.GameEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.PlayerJoined.serializeBinaryToWriter
    );
  }
...
/**
 * optional PlayerJoined player_id = 1;
 * @return {?proto.PlayerJoined}
 */
proto.GameEvent.prototype.getPlayerId = function() {
  return /** @type{?proto.PlayerJoined} */ (
    jspb.Message.getWrapperField(this, proto.PlayerJoined, 1));
};


/**
 * @param {?proto.PlayerJoined|undefined} value
 * @return {!proto.GameEvent} returns this
*/
proto.GameEvent.prototype.setPlayerId = function(value) {
 ...
 * @return {!proto.GameEvent} returns this
 */
proto.GameEvent.prototype.clearPlayerId = function() {
 ...
 * @return {boolean}
 */
proto.GameEvent.prototype.hasPlayerId = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {?proto.GameState}
 */
proto.GameEvent.prototype.getGameState = function() {
 ...
 * @return {!proto.GameEvent} returns this
*/
proto.GameEvent.prototype.setGameState = function(value) {
 ...
 * @return {!proto.GameEvent} returns this
 */
proto.GameEvent.prototype.clearGameState = function() {
 ...
 * @return {boolean}
 */
proto.GameEvent.prototype.hasGameState = function() {
  return jspb.Message.getField(this, 2) != null;
};
