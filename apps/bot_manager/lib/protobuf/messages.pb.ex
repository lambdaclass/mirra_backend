...
defmodule BotManager.Protobuf.Player do
  ...
  field(:effects, 11, repeated: true, type: BotManager.Protobuf.Effect)
  ...
  field(:inventory, 22, repeated: true, type: BotManager.Protobuf.Player.InventoryEntry, map: true)
