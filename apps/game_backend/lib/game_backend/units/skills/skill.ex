defmodule GameBackend.Units.Skills.Skill do
  ...
  def changeset(skill, attrs \\ %{}) do
    skill
    |> cast(attrs, [:name, :cooldown, :energy_regen, :animation_duration, :buff_id, :activation_delay_ms, :autoaim, :block_movement, :can_pick_destination, :cooldown_mechanism, :cooldown_ms, :execution_duration_ms, :inmune_while_executing, :is_passive, :max_autoaim_range, :stamina_cost])
