...
defmodule Arena.Serialization.Player do
  ...
  field(:effects, 11, repeated: true, type: Arena.Serialization.Effect)
  ...
  field(:inventory, 22, repeated: true, type: Arena.Serialization.Player.InventoryEntry, map: true)
