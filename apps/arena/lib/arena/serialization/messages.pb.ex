...
defmodule Arena.Serialization.GameState.PlayerMovementTimestampsEntry do
  @moduledoc false
...
defmodule Arena.Serialization.GameState.PlayerActionsTimestampsEntry do
  @moduledoc false
...
defmodule Arena.Serialization.GameState do
  ...
  field(:player_movement_timestamps, 4,
    repeated: true,
    type: Arena.Serialization.GameState.PlayerMovementTimestampsEntry,
  ...
  field(:player_actions_timestamps, 5,
    repeated: true,
    type: Arena.Serialization.GameState.PlayerActionsTimestampsEntry,
    json_name: "playerActionsTimestamps",
    map: true
  )

  field(:server_timestamp, 6, type: :int64, json_name: "serverTimestamp")
  field(:zone, 7, type: Arena.Serialization.Zone)
  field(:killfeed, 8, repeated: true, type: Arena.Serialization.KillEntry)
  ...
  field(:status, 12, type: Arena.Serialization.GameStatus, enum: true)
  field(:countdown, 13, type: :int64)
  field(:items, 14, repeated: true, type: Arena.Serialization.GameState.ItemsEntry, map: true)
end
