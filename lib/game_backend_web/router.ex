defmodule GameBackendWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {GameBackendWeb.Layouts, :root}
  ...
  if Application.compile_env(:game_backend, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: GameBackendWeb.Telemetry
