defmodule GameBackend.WsClient do
  @moduledoc """
  false
  """
  use WebSockex
  ...
  def send_command(pid, _command) do
    direction = %GameBackend.Protobuf.Direction{x: 1.0, y: 0.0}
    direction_encoded = GameBackend.Protobuf.Direction.encode(direction)
